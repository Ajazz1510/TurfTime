...
import { Menu, X, Sparkles, Footprints, Clock, User } from "lucide-react";
...
export default function Header() {
  ...
  return (
    <header className="bg-black/95 backdrop-blur-sm border-b border-green-900/40 sticky top-0 z-50">
