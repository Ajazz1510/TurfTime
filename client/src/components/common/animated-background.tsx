...
export default function AnimatedBackground({ className }: AnimatedBackgroundProps) {
  ...
  return (
    <div className={`fixed inset-0 -z-10 overflow-hidden pointer-events-none ${className || ""}`}>
      ...
      <motion.div
        className="absolute w-[500px] h-[500px] rounded-full bg-gradient-to-r from-green-500/10 to-green-300/5 blur-3xl"
        animate={{
          x: ["-20%", "120%"],
          y: ["10%", "60%"],
        }}
      ...
      <motion.div
        className="absolute w-[300px] h-[300px] rounded-full bg-gradient-to-r from-emerald-500/10 to-emerald-300/5 blur-3xl"
        animate={{
          x: ["70%", "30%"],
          y: ["70%", "30%"],
        }}
