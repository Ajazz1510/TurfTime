    ...
    return (<div className="min-h-screen bg-black flex flex-col">
      ...
      <div className="flex flex-1 flex-col md:flex-row">
        ...
        <div className="fixed inset-0 overflow-hidden pointer-events-none">
          ...
          {/* Animated elements */}
          <div className="absolute w-12 h-12 rounded-full border-2 border-green-500/20 animate-float opacity-20" style={{ top: '20%', left: '15%', animationDelay: '0.5s' }}></div>
          <div className="absolute w-8 h-8 rounded-full bg-green-500/10 animate-float-slow opacity-10" style={{ top: '60%', right: '10%', animationDelay: '1s' }}></div>
          <div className="absolute w-6 h-6 transform rotate-45 border-t-2 border-l-2 border-green-400/10 animate-pulse-slow opacity-20" style={{ bottom: '15%', left: '20%', animationDelay: '2.5s' }}></div>
          <div className="absolute h-px w-40 bg-gradient-to-r from-transparent via-green-500/20 to-transparent animate-pulse-slow" style={{ top: '40%', right: '15%', animationDelay: '1.7s' }}></div>
        </div>
                ...
                <CardContent>
                  <Form {...loginForm}>
                    <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-4">
                      <FormField control={loginForm.control} name="username" render={({ field }) => (<FormItem>
                      ...
                      <FormField control={loginForm.control} name="password" render={({ field }) => (<FormItem>
                  ...
                  <div className="mt-4 text-center text-sm">
                    ...
                    <button className="text-primary hover:underline font-medium" onClick={() => setActiveTab("register")}>
                      Register
                    </button>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <Form {...registerForm}>
                    <form onSubmit={registerForm.handleSubmit(onRegisterSubmit)} className="space-y-4">
                      <FormField control={registerForm.control} name="fullName" render={({ field }) => (<FormItem>
                      ...
                      <FormField control={registerForm.control} name="email" render={({ field }) => (<FormItem>
                      ...
                      <FormField control={registerForm.control} name="username" render={({ field }) => (<FormItem>
                            <FormLabel>Username</FormLabel>
                            <FormControl>
                              <Input placeholder="johndoe" {...field}/>
                            </FormControl>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <FormField control={registerForm.control} name="password" render={({ field }) => (<FormItem>
                              <FormLabel>Password</FormLabel>
                              <FormControl>
                                <Input type="password" placeholder="••••••••" {...field}/>
                              </FormControl>
                        ...
                        <FormField control={registerForm.control} name="confirmPassword" render={({ field }) => (<FormItem>
                      ...
                      <FormField control={registerForm.control} name="role" render={({ field }) => (<FormItem>
                      ...
                      {showBusinessFields && (<FormField control={registerForm.control} name="businessName" render={({ field }) => (<FormItem>
                      ...
                      <FormField control={registerForm.control} name="phone" render={({ field }) => (<FormItem>
                      ...
                      <FormField control={registerForm.control} name="terms" render={({ field }) => (<FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                            <FormControl>
                  ...
                  <div className="mt-4 text-center text-sm">
                    ...
                    <button className="text-primary hover:underline font-medium" onClick={() => setActiveTab("login")}>
                      Login
                    </button>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input id="otp" placeholder="Enter OTP code" className="text-center text-xl tracking-widest" maxLength={6} onChange={(e) => {
            // Only allow numbers
    ...
    >
                    ...
                    <div className="text-center">
                      <span className="text-sm text-gray-500">
                        ...
                        <button className="text-primary hover:underline ml-1 font-medium" onClick={() => {
            // Request a new OTP
            requestOtpMutation.mutate({ username: otpUsername });
                    ...
                    <div className="text-center">
                      <button className="text-sm text-gray-500 hover:underline" onClick={() => setActiveTab("login")}>
                        Return to login
                      </button>
                    </div>
                  </div>
      ...
      <div className="w-full md:w-1/2 bg-gradient-to-br from-green-900 to-primary hidden md:flex flex-col justify-center items-center px-5 md:px-10 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          {/* Field lines */}
          <div className="absolute h-px w-60 bg-gradient-to-r from-transparent via-green-400/20 to-transparent animate-pulse-slow" style={{ top: '20%', right: '5%', animationDelay: '0.7s' }}></div>
          <div className="absolute h-px w-40 bg-gradient-to-r from-transparent via-green-400/20 to-transparent animate-pulse-slow" style={{ bottom: '30%', left: '10%', animationDelay: '1.2s' }}></div>
